            ...
            <div className="flex flex-col sm:flex-row sm:justify-center lg:justify-start items-center gap-6 sm:gap-8 pt-6">
              {buttons.map((button, index) => (
                ...
                >
                  ...
                  <div className="w-8 h-8 bg-black rounded-full text-white transition-colors duration-500 
                  group-hover:bg-white group-hover:bg-opacity-0 group-hover:text-white z-10">
                    <svg
                  ...
                  <Link
            href="/learn-more"
            className="hidden md:block text-lg text-gray-800 hover:text-gray-900 no-underline"
          >
            • Learn More 
          </Link>
            </div>
