...
export default function Pricing4() {
  ...
  const faqs = [
    ...
    {
      question: "How do I get started with ShiftSaaS?",
      answer:
        "Getting started with [Your Company/Service] is easy. Simply [provide a brief overview of the onboarding process, sign-up procedure, or initial steps]. If you have any questions or need assistance, our support team is here to guide you through the process.",
    },
  ];
